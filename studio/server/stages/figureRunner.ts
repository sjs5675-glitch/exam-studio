 ...
 * Only when needsAgentReview.length > 0 should the caller dispatch exam-figure agent.
 */
 ...
 * Callers must check `needsAgentReview` and conditionally dispatch exam-figure agent.
 */
